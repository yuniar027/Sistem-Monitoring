<x-filament-panels::page>
    ...
    @if ($this->isPabrik())
        {{-- Pabrik: cuma 1 kartu pintas ke Input Titip Pabrik (bagian yang bisa mereka edit) --}}
        ...
        <a href="{{ \App\Filament\Resources\StokHarianGudangResource::getUrl('index') }}"
           style="display: block; max-width: 420px; text-decoration: none; background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 0.75rem; padding: 1.5rem;">
            <div style="font-size: 1.15rem; font-weight: 700; color: #111827; margin-bottom: 0.25rem;">
                Input Titip Pabrik
            </div>
            <div style="font-size: 0.9rem; color: #4b5563;">
                Isi jumlah barang yang dititipkan hari ini. Data lain di sistem ini bisa kamu lihat, tapi cuma bagian ini yang bisa diubah.
            </div>
        </a>
    @else
